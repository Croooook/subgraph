...
export class Staker__depositsResult {
  value0: Address;
  value1: BigInt;
  value2: i32;
  value3: i32;
...
export class Staker__endIncentiveInputKeyStruct extends ethereum.Tuple {
  get rewardToken(): Address {
...
export class Staker__getRewardInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class Staker__getRewardInfoInputKeyStruct extends ethereum.Tuple {
  get rewardToken(): Address {
    return this[0].toAddress();
  }
...
export class Staker__incentivesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Staker__stakesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Staker extends ethereum.SmartContract {
  ...
  deposits(param0: BigInt): Staker__depositsResult {
    let result = super.call(
      "deposits",
    ...
    return new Staker__depositsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toI32()
  ...
  try_deposits(param0: BigInt): ethereum.CallResult<Staker__depositsResult> {
    let result = super.tryCall(
      "deposits",
      "deposits(uint256):(address,uint48,int24,int24)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  endIncentive(key: Staker__endIncentiveInputKeyStruct): BigInt {
    let result = super.call(
      "endIncentive",
  ...
  try_endIncentive(
    key: Staker__endIncentiveInputKeyStruct
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "endIncentive",
      "endIncentive((address,address,uint256,uint256,address)):(uint256)",
  ...
  getRewardInfo(
    key: Staker__getRewardInfoInputKeyStruct,
    tokenId: BigInt
  ): Staker__getRewardInfoResult {
    let result = super.call(
      "getRewardInfo",
    ...
    return new Staker__getRewardInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getRewardInfo(
    key: Staker__getRewardInfoInputKeyStruct,
    tokenId: BigInt
  ): ethereum.CallResult<Staker__getRewardInfoResult> {
    let result = super.tryCall(
      "getRewardInfo",
      "getRewardInfo((address,address,uint256,uint256,address),uint256):(uint256,uint160)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staker__getRewardInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  incentives(param0: Bytes): Staker__incentivesResult {
    let result = super.call(
      "incentives",
    ...
    return new Staker__incentivesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_incentives(param0: Bytes): ethereum.CallResult<Staker__incentivesResult> {
    let result = super.tryCall(
      "incentives",
      "incentives(bytes32):(uint256,uint160,uint96)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  stakes(tokenId: BigInt, incentiveId: Bytes): Staker__stakesResult {
    let result = super.call(
      "stakes",
    ...
    return new Staker__stakesResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_stakes(
    tokenId: BigInt,
    incentiveId: Bytes
  ): ethereum.CallResult<Staker__stakesResult> {
    let result = super.tryCall(
      "stakes",
      "stakes(uint256,bytes32):(uint160,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staker__stakesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
